...
class WpfConfigForm:
    def __init__(self, wall_data, floor_data, level_data, default_level_id=None):
        ...
        # >> MUDANÇA: Encontra o novo botão na interface
    ...
    def conectar_eventos(self):
        ...
        # >> MUDANÇA: Conecta o evento de clique do novo botão à sua função
        self.btn_tutorial.Click += self.tutorial_button_click

    # >> MUDANÇA: Nova função para lidar com o clique do botão de tutorial
...
def create_walls_for_room(doc, room, wall_settings, creation_level_id):
    ...
    for wall_curve, host_wall in all_curves:
        try:
            ...
            if safe_get(wall_settings, "method") == "Valor":
                ...
                skirting = Wall.Create(doc, wall_curve, wall_type_id, level_id_to_use, height, 0, True, False)
            else:
                top_level_id = safe_get(wall_settings, "level_id")
                if top_level_id is None: continue
                skirting = Wall.Create(doc, wall_curve, wall_type_id, level_id_to_use, 1.0, 0, True, False)
                ...
                try:
                    ...
                    for room in all_rooms:
                        ...
                        if safe_get(user_settings, "create_walls"):
                            walls_from_room = create_walls_for_room(doc, room, user_settings["wall_settings"], active_level_id)
