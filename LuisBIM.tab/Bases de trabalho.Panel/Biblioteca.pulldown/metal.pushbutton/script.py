...
file_options = ["ESTRUTURA-METALICA.rte", "ESTRUTURA-METALICA.rvt"]
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir metal.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir metal.txt"
    try:
