...
file_options = ["MOBILIARIOS.rte", "MOBILIARIOS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'MOBILIARIOS.rte' ou 'MOBILIARIOS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir cozinha.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir cozinha.txt"
    try:
