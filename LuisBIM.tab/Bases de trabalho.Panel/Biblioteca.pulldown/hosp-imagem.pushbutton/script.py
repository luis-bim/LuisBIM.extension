...
file_options = ["HOSPITALAR-IMAGENOLOGIA.rte", "HOSPITALAR-IMAGENOLOGIA.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'HOSPITALAR-IMAGENOLOGIA.rte' ou 'HOSPITALAR-IMAGENOLOGIA.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir vegetacao.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir vegetacao.txt"
    try:
