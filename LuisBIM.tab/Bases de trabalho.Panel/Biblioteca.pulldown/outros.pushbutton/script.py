...
file_options = ["OUTROS.rte", "OUTROS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'OUTROS.rte' ou 'OUTROS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir outros.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir outros.txt"
    try:
