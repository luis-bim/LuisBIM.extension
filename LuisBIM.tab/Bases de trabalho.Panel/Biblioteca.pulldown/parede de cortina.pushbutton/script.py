...
file_options = ["PAREDE-DE-CORTINA.rte", "PAREDE-DE-CORTINA.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'PAREDE-DE-CORTINA.rte' ou 'PAREDE-DE-CORTINA.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir parede cortina.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir parede cortina.txt"
    try:
