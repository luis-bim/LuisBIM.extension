...
file_options = ["ELEVADORES.rte", "ELEVADORES.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'ELEVADORES.rte' ou 'ELEVADORES.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abri elevador.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abri elevador.txt"
    try:
