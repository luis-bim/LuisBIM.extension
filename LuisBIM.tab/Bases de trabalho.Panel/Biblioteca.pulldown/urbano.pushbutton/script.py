...
file_options = ["URBANO-MOBILIARIO.rte", "URBANO-MOBILIARIO.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'URBANO-MOBILIARIO.rte' ou 'URBANO-MOBILIARIO.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abri brise.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir urbano.txt"
    try:
