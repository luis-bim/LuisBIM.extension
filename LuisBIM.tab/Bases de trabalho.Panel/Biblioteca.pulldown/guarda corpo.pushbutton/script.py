...
file_options = ["GUARDA-CORPO.rte", "GUARDA-CORPO.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'GUARDA-CORPO.rte' ou 'GUARDA-CORPO.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir guarda-corpo.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir guarda-corpo.txt"
    try:
