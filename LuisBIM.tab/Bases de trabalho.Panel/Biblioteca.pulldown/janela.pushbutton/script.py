...
file_options = ["ESQUADRIAS-JANELAS.rte", "ESQUADRIAS-JANELAS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'ESQUADRIAS-JANELAS.rte' ou 'ESQUADRIAS-JANELAS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abri janela.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abri janela.txt"
    try:
