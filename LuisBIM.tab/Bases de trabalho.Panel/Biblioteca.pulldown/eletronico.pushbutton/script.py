...
file_options = ["ELETRODOMESTICOS.rte", "ELETRODOMESTICOS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'ELETRODOMESTICOS.rte' ou 'ELETRODOMESTICOS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir mobiliario.txt")
