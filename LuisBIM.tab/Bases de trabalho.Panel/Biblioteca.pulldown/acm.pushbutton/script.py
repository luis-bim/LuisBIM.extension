...
file_options = ["ACABAMENTO-ACM.rte", "ACABAMENTO-ACM.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'ACABAMENTO-ACM.rte' ou 'ACABAMENTO-ACM.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abri revestimento acm.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abri revestimento acm.txt"
    try:
