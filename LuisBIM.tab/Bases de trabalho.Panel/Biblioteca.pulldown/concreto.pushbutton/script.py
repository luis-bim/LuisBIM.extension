...
file_options = ["ESTRUTURA-CONCRETO.rte", "ESTRUTURA-CONCRETO.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'ESTRUTURA-CONCRETO.rte' ou 'ESTRUTURA-CONCRETO.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir concreto.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir concreto.txt"
    try:
