...
file_options = ["LOUCAS-METAIS.rte", "LOUCAS-METAIS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'LOUCAS-METAIS.rte' ou 'LOUCAS-METAIS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir loucas e metais.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir loucas e metaiss.txt"
    try:
