...
file_options = ["HIDRO-RESERVATORIOS.rte", "HIDRO-RESERVATORIOS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'HIDRO-RESERVATORIOS.rte' ou 'HIDRO-RESERVATORIOS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abrir reservatórios.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abrir reservatórios.txt"
    try:
