...
file_options = ["ESQUADRIAS-PORTAS.rte", "ESQUADRIAS-PORTAS.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'ESQUADRIAS-PORTAS.rte' ou 'ESQUADRIAS-PORTAS.rvt' encontrado na pasta.")
...
try:
    ...
    # Caminho do arquivo de log (arquivo: "abri posta.txt")
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abri porta.txt"
    try:
