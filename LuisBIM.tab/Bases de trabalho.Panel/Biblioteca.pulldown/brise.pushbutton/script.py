...
file_options = ["BRISE-SOLEIL.rte", "BRISE-SOLEIL.rvt"]
...
if template_file is None:
    raise Exception("Nenhum arquivo 'BRISE-SOLEIL.rte' ou 'BRISE-SOLEIL.rvt' encontrado na pasta.")
...
try:
    ...
    log_file_path = r"G:\Drives compartilhados\BIM\AUTOMACAO\LOGS\pyRevit\abri brise.txt"
    try:
